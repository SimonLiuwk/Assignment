...
//     let res = "";
//     res = parseFloat(input.toString().split("").reverse().join(""))* Math.sign(num);
//     return res;
// }

// let num = -540.00;
// console.log(reserveNumber(num));
...
// let str = "asd asd asd dsa dsa dsa";
...
// console.log(upperCaseInitialLetter(str))
...
// let str = "Web Development Tutorial asdf upperCaseInitialLetter";
