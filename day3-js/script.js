...
function getFixedSubsets(arr,len){
    let res = [];
    function getSubsets(currentArr,index){
...
let arr21=[1,2,3,4],len21=2;
console.log("21:", getFixedSubsets(arr21,len21))
